...
Rscript ~/git/temperature_violence_medicaid_2022/code/models/c_04_model_sensitivity_freq.R ${SLURM_ARRAY_TASK_ID}

# to run use
# sbatch c_00_model_main_freq_sensitivity.sh

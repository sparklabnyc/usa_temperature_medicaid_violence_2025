...
Rscript ~/git/temperature_violence_medicaid_2022/code/model_processing/d_03_process_model_results_sensitivity.R;

# to run use
# sbatch d_00_process_model_results_sensitivity.sh

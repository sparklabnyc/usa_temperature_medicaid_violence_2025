...
for (analysis in analyses_made){
  print(analysis)
  dat.results = rbind(dat.results,invisible(process_results_linear(analysis,exposure,1)))
}
...
dat.results %>%
  write.csv(paste0(cause.model.exploration.folder,'overall_dlnm_results_freq_lag01.csv'),row.names = FALSE)

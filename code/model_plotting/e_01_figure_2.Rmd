...
pdf(paste0(figure2.folder,'figure2.pdf'),paper='a4r',height=0,width=0)
print(p)
dev.off()
...
pdf(paste0(figure2.folder,'figure2_option2.pdf'),paper='a4',height=0,width=0)
print(p2)
dev.off()
